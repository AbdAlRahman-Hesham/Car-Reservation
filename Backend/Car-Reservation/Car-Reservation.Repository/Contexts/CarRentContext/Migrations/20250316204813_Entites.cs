        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedModel = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    RequestedBrand = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestUser", x => new { x.RequestsId, x.UserId });
                    table.ForeignKey(
